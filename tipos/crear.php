...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        try {
            ...
            $stmt->execute([$nombre, $descripcion !== '' ? $descripcion : null, $nivel]);
            header('Location: index.php?ok=1');
            exit;
        } catch (PDOException $e) {
            if ((int)$e->getCode() === 23000) {
                $errores[] = 'Ya existe un tipo con ese nombre (restricción UNIQUE).';
            } else {
...
$titulo = 'Nuevo Tipo de Incidente';
require_once '../includes/header.php';
?>

<div class="row justify-content-center">
    <div class="col-lg-7">
        <h2 class="mb-3"><i class="bi bi-plus-circle"></i> Nuevo Tipo de Incidente</h2>
