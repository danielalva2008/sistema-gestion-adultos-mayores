-- Solo para una base nueva. Se detiene si sistema_residencia ya existe.
-- Fuente: rama feature/grupo-5-incidentes, commit 6a94b63.
-- Ajuste: se completa con NULL el responsable faltante del octavo incidente.
-- ============================================================
...
(2,3,NULL,'2026-09-08 09:10:00','Habitación 101',
